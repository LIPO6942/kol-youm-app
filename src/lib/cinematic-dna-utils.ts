...
const ARCHETYPE_RULES: Array<{
  ...
  {
    match: (c1, c2) => (c1 === 'Sci-Fi' && c2 === 'Drame') || (c1 === 'Drame' && c2 === 'Sci-Fi'),
    archetype: (c1, c2) => ({
      id: 'penseur-futur',
      title: "Le Penseur du Futur",
      badge: "🚀🎭 Sci-Fi & Drame",
      tagline: "Esprit analytique fasciné par les vertiges existentiels et les dilemmes humains de demain.",
      description: "Vous aimez quand un film allie réflexion philosophique profonde et visions futuristes grandioses. De Blade Runner à Interstellar ou Her, vous recherchez l'âme humaine derrière la technologie.",
      gradient: "from-cyan-400 via-blue-600 to-purple-800",
      primaryCategory: c1,
      secondaryCategory: c2,
    }),
  },
  ...
  },
  {
    ...
    archetype: (c1, c2) => ({
      id: 'temoin-histoire',
      title: "Le Témoin de l'Histoire",
      badge: "🎙️⚔️ Documentaire & Histoire",
      tagline: "Gardien de la mémoire collective, des archives poignantes et des récits d'époque.",
      description: "Vous êtes fasciné par les documents d'époque, les batailles décisives et les destins brisés par les tourments de l'Histoire. Vous cherchez à comprendre le présent à travers la rigueur des faits passés.",
      gradient: "from-teal-600 via-amber-700 to-stone-900",
      primaryCategory: c1,
      secondaryCategory: c2,
    }),
  },
  ...
  },
  {
    ...
    archetype: (c1, c2) => ({
      id: 'detective-faits-reels',
      title: "Le Détective des Faits Réels",
      badge: "🎙️🕵️‍♂️ Docu & Polar",
      tagline: "Passionné par les cold cases, les grandes affaires judiciaires et les coulisses d'enquêtes.",
      description: "Vous aimez la traque minutieuse des faits, les contre-enquêtes et la psychologie criminelle ancrée dans la réalité la plus brute. Pour vous, aucun scénario inventé n'égale le mystère d'un vrai dossier criminel.",
      gradient: "from-teal-600 via-blue-800 to-slate-950",
      primaryCategory: c1,
      secondaryCategory: c2,
    }),
  },
...
const SINGLE_GENRE_ARCHETYPES: Record<MovieCategory, { title: string; badge: string; tagline: string; description: string; gradient: string }> = {
  ...
  'Documentaire': {
    title: "Le Chercheur de Vérités",
    badge: "🎙️ Spécialiste Documentaire",
    tagline: "Passionné par le monde réel, les enquêtes fouillées et les témoignages authentiques.",
    description: "Pour vous, la réalité dépasse toujours la fiction. Vous aimez comprendre les rouages du monde, observer la nature ou revivre les grands événements humains sans artifices.",
...
const TV_ARCHETYPE_RULES: Array<{
...
}> = [
  {
    match: (c1, c2) => (c1 === 'Documentaire' && c2 === 'Crime/Policier') || (c1 === 'Crime/Policier' && c2 === 'Documentaire'),
    archetype: (c1, c2) => ({
      id: 'analyste-true-crime',
      title: "L'Analyste True Crime",
      badge: "📺🎙️ True Crime & Polar",
      tagline: "Passionné d'affaires non résolues, de docu-séries judiciaires et d'enquêtes au long cours.",
      description: "De Making a Murderer à The Jinx, vous décortiquez chaque pièce à conviction. Vous appréciez la rigueur journalistique et l'immersion dans les arcanes de la justice.",
...
const SINGLE_GENRE_TV_ARCHETYPES: Record<MovieCategory, {
  ...
  'Documentaire': {
    ...
    tagline: "Fasciné par les docu-séries, le journalisme d'investigation et les récits immersifs.",
    description: "Du true crime aux fresques animalières ou scientifiques, vous dévorez les séries documentaires qui décortiquent notre monde avec rigueur et sensibilité.",
    gradient: "from-teal-500 via-emerald-700 to-cyan-900",
  },
  'Suspense & Thriller': {
